...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func createTabbar() -> UITabBarController{
        ...
        tabbar.viewControllers = [createTopStoriesNavigationController(),createFavouritesNavigationController()]
        return tabbar
    }
    
    func createTopStoriesNavigationController() -> UINavigationController{
        let topStoriesVC = TopStoriesViewController()
        topStoriesVC.title = "Top Stories"
        topStoriesVC.tabBarItem = UITabBarItem(tabBarSystemItem: .mostViewed, tag: 0)
        return UINavigationController(rootViewController: topStoriesVC)
    }
